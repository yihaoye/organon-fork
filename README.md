...
* 信息管理
  ...
  * 信息理解 - *如何从不直观的沟通（比如花言巧语）中一针见血找出真正的含义或隐藏的实情*
    ...
    * 人类思维思路的特征
      * [事实应是简单的所以额外的用力说服是可疑的、以及真相常常是混乱的不工整流畅的](https://www.youtube.com/shorts/6TgZjtCRy44)
  * 认知管控 - *通常称为洗脑，但该词并不严谨、带有主观评价从而容易引起反感情绪与偏见，而且过于局限忽略了里面涵盖的许多专业知识*
    ...
    * 利用人的生物性弱点
      ...
      * 认知偏差
        ...
        * **[框架效应](https://www.woshipm.com/it/1156569.html)/二元思维/非黑即白**、**程度混淆** - *比如天下乌鸦一般黑*
      * 耻感 - *基于尊严（面子）等原因不愿意轻易承认过去可能犯下的认知错误*
      * 负荷极限 - *个体的智力、能力是有限的，面对复杂烧脑的议题辩论时可以使用谬误误导大众（具体参考下面的谬误列表），俗称脑子转不过来、认知负荷、[决策疲劳](https://wiki.mbalib.com/wiki/%E5%86%B3%E7%AD%96%E7%96%B2%E5%8A%B3)、信息过载（参考下面解释）。另外还有一种情况是故意制造让目标疲于奔命的环境，使之不能分配有限的资源比如时间精力到相关事物、议题的探索、研究上*
        * [议题设定](https://zh.wikipedia.org/zh-hans/%E8%AD%B0%E9%A1%8C%E8%A8%AD%E5%AE%9A) - *是指传播学里对特定焦点的设置*
...
* [逻辑基础](https://zh.wikipedia.org/wiki/%E7%BB%8F%E5%85%B8%E9%80%BB%E8%BE%91)
  ...
  * [逻辑谬误](https://zh.wikipedia.org/zh-hans/%E8%AC%AC%E8%AA%A4%E5%88%97%E8%A1%A8) - *逻辑谬误与认知偏差、扭曲的区别是后者是自动思维的类别，以下仅列举常见的重要谬误*
    ...
    * [赌徒谬误](https://zh.wikipedia.org/zh-hans/%E8%B3%AD%E5%BE%92%E8%AC%AC%E8%AA%A4) - *是一种机率谬误，主张由于某事发生了很多次，因此接下来不太可能发生；或者由于某事很久没发生，因此接下来很可能会发生*
    ...
    * **诉诸非逻辑** - *使用包括可能性、动机、道德、人身、权威、资格、情感、传统、习俗、信仰等作为论据；诉诸人身的例子如通过指控一个人的私生活不检点来降低其在不相关的话题上的公信力，而[道德绑架](https://wiki.mbalib.com/wiki/%E9%81%93%E5%BE%B7%E7%BB%91%E6%9E%B6)就是诉诸道德的典型（研究显示[道德愤慨会助长虚假信息传播](https://www.science.org/doi/10.1126/science.adl2829)），又比如讨论时不应该把事实与立场混为一谈，又比如谚语老话不能作为严谨的论据*
      ...
      * [“那又怎么说”论](https://zh.wikipedia.org/wiki/%E3%80%8C%E9%82%A3%E5%8F%88%E6%80%8E%E9%BA%BC%E8%AA%AA%E3%80%8D%E8%AB%96) - 是应对指控时，不回答或讨论关键问题或论点，反指控对方或提出其他关键问题，以反驳指控的一种技巧或行为。这种技巧被认为是"你也一样"谬误的变体和诉诸人身的子类型。
  ...
  * 统计规律 / 猜想证明 - *大部分动物本能都会找规律、假设以更好地生存，但是有的时候找到的规律不一定是严谨的因果关系，比如巴普洛夫条件反射*
    * [相关性](https://zh.wikipedia.org/zh-hans/%E7%9B%B8%E5%85%B3_(%E6%A6%82%E7%8E%87%E8%AE%BA)) / [猜想](https://zh.wikipedia.org/wiki/%E7%8C%9C%E6%83%B3)（经验法、假设、找规律、特征法、最佳实践）- *比如传统草药的柳树皮用于解热镇痛，但如果柳树种类欠缺水杨苷或病患不能有效吸收将水杨苷转化为水杨酸或柳树种类含额外毒素则治疗效果不佳，所以柳树皮只与疗效相关但不是原因，有意思的是这类经验法不是人类独有，自然界动物也有为了治病而服用植物的案例。另外一个著名的统计学相关性谬误：同季的冰激凌销售量与溺水数量成正比*
...
* [解决问题](https://en.wikipedia.org/wiki/Problem_solving)、事务执行
  * [分工与专业化](https://zh.wikipedia.org/wiki/%E5%88%86%E5%B7%A5) - *任何系统或组织中的任务资源分离，以便参与者可以专业化，让专业的人做专业的事，从而提高效率，在《国富论》中被突出强调；例子如混混打不过职业拳手、游勇草寇打不过职业军队，现实中还有如流水线、组织架构、投资组合、分级诊疗、层级缓冲等；最后，商业就是基于分工与交易的*
    * [协同效应](https://zh.wikipedia.org/wiki/%E5%8D%94%E5%90%8C%E6%95%88%E6%87%89)，又称加乘性，指 “一加一大于二” 的效应，可以是正面也可以是负面。例如商业环境，市场或企业并购，有可能产生互补不足的协同效应；在医药领域，是指两种或两种以上的物质经相互混合后，其效果大于每一种物质单独起到的作用效果的现象；两种或两种以上的毒物经相互混合后，其毒性增加，死亡率高于预期的百分比。
  ...
  * [解决策略](https://untools.co/)与[任务管理](https://zh.wikipedia.org/zh-hans/%E6%97%B6%E9%97%B4%E7%AE%A1%E7%90%86)
    * **艾森豪威尔四象法** - 优先级排序：紧急重要（马上做）、重要不紧急（制定计划做）、紧急不重要（委托别人去做）、不重要不紧急（少做或不做）
      * 可再细分：低能耗任务（比如重复性、弱严谨的工作）、高能耗任务（比如学习或复杂多变、强严谨的工作）- *根据个人当前状态来安排优先级，比如疲惫或精力不佳时先做低能耗任务，从而先达到启动起来，通常可以借此慢慢进入状态进而也可以执行高能耗任务，否则可能因为启动困难导致厌烦情绪、工作频频暂停且因此产生愧疚的恶性循环的“拖延症”，在现实计算机系统中也有类似的案例如[最短作业优先 SJF](https://zh.wikipedia.org/wiki/%E7%9F%AD%E8%BF%9B%E7%A8%8B%E4%BC%98%E5%85%88)*；出于人的精神健康、成就感考虑，需要低耗能任务与高耗能任务混合，长期只有其中一种容易导致心理健康问题
      * [价值优先法](https://www.youtube.com/watch?v=mvgN7wr_nOU)
    * 启动技巧
    ...
    * 进展方式 - 根据情况选择，影响因素包括下面的严谨性与效率权衡等等
      ...
      * [逐步推进 / 自下而上](https://zh.wikipedia.org/wiki/%E6%B8%90%E8%BF%9B%E4%B8%BB%E4%B9%89) - 循规蹈矩，通过循序渐进的方式进行改变或制定政策的理念或方法。这种方法强调在决策和行动中采取小步骤，并在每一步中进行适度的调整和改进。渐进法通常与大规模的革命性变革相对应，它更注重渐进地修正和调整，以适应变化的环境或需求。与下面的量变、质变相关。比如堆砌哲学在大功率火箭助推器上的实践。
...
* 情绪管理 - *本质是避免动荡，保持稳态*
  * **培养习惯与训练 - 在日常生活中时时刻刻践行正念与认真思维，就可以减少下意识动物性反应和不理智行为，不用在社交场合中掩盖、伪装、害怕失态或做错事（但必要的保密和策略性行为依然重要，两者并不冲突）**
...
* 人际管理
  * 两种人际关系：情感型、商业型（交易型）- 其中可对应社会类型：[熟人社会](https://zh.wikipedia.org/zh-hans/%E5%B7%AE%E5%BA%8F%E6%A0%BC%E5%B1%80)、契约社会（事实上无论是这两种人际关系还是社会类型，都不是绝对的非此即彼的，而是互有重叠的）；*商业型人际关系比如有合作伙伴、甲方乙方、同事、上司、下属等等，当然这些关系也可能会因为利益不再相关而消失或转变成情感型*
    * 敌对关系 - 正视敌人（不贬低、轻视）是尊重自己，因为战胜有实力的敌人是对自身的证明。
  * 互动准则
    ...
    * [情绪勒索](https://zh.wikipedia.org/zh-hans/%E6%83%85%E7%B7%92%E5%8B%92%E7%B4%A2) - *反例，指一种在关系中不愿意为自己的负面情绪负责，并企图以威胁利诱控制他人的行为模式，[应对情绪勒索的方法 - 完全无视对方情绪然后不带情绪地就事论事，并在传递完关键信息后果断结束对话](https://www.youtube.com/watch?v=QHHUbtCnu5U)；类似社会现象还有[刻奇](https://zh.wikipedia.org/wiki/%E5%AA%9A%E4%BF%97)*
  * 表达技巧 - 深于思而敏于言：最重要的是改善思考方式，比如一些不尊重的想法平时要纠正、不合理的思维要反省，因为言多必失，表达技巧终究只是形式的
    ...
    * 言之有物、说话不轻率，讲出口前深思熟虑，[快慢思考](https://book.douban.com/subject/10785583/)
  * 冲突管理 - 6 种方式：开放诚实的足量沟通、理解对方、寻找共同点、尝试协商与合作、控制情绪、寻求中立帮助
  * 人性 - 这里并不是同意七宗罪，而只是列出一些客观人性，而且一些特质并不一定是负面的，比如懒惰可以驱动创造
    * 怠惰 - 可以通过往自己擅长的方向来努力，人们怠惰往往是因为相关领域不是自己所长
    * 嫉妒 - 坚定地做自己、了解自己可以有效减轻嫉妒之心
    * 傲慢、虚荣 - 傲慢源于浅薄，越是有智慧知识的人越是会自然而然地谦逊、因为懂得越多就会疑问越多，同时品格越不以自我为中心也会越少傲慢与虚荣
    * 纵欲、贪婪 - 适度的欲望、贪欲可以是进步之源
    * 自私 - 在适度边界内的自私是合理的，符合趋利避害自然法则，是社会产权的基础，可以推动社会进步。过度的自私则源于短视，一个人可以走得很快，一群人才能走得更远
...
* [系统理论](https://writings.sh/post/cybernetics-and-scientific-methodology-notes) - *我又不是工程师，为什么要了解系统？因为实际现实生活中充满了系统，不限虚实（星系、生态、产品、工程、企业、族群、经济、生命、财务、商业模式等等），而系统泛指由一群有关联的个体组成，根据某种规则运作，能完成个别元件不能单独完成的工作的群体。所以系统的理论可以广泛应用在工作生活，值得了解学习*
  * 系统基本分类 - 自然系统与人为系统
    * 其他分类 - 简单系统，简单巨系统，复杂巨系统
      * 加尔定律 - 有效的复杂系统总是从简单的系统演化而来，反之从零设计的复杂系统没一个能有效工作的（约翰・加尔 《Systemantics》 1975）
  * 系统的 3 种可能状况
  ...
  * [封闭系统](https://zh.wikipedia.org/zh-hans/%E5%B0%81%E9%96%89%E7%B3%BB%E7%B5%B1) vs [开放系统](https://zh.wikipedia.org/zh-hans/%E9%96%8B%E6%94%BE%E7%B3%BB%E7%B5%B1_(%E7%86%B1%E5%8A%9B%E5%AD%B8))
    ...
    * 可持续发展 - *系统建设需要考虑对关联系统的影响，比如商业模式中的层叠式销售（传销）模式就只对关联系统（社会）造成逆差因此不是永续经营的模式*
  * 反馈 - 反馈可以是恒定的或动态的
  ...
  * [反熵增（发展与维护、混乱度治理）](https://www.madewill.com/thinking-model/the-entropy.html)- *万物（包括个人发展、成长）有着自发增熵的倾向，即失序、混乱度的增大，因此需要建立明确目标规划且持续地负反馈调节；也因此可知一劳永逸的服务系统是不存在的，比如永动机、财务自由都是虚假的，任何事物与系统都需要投入成本进行维护。* 与稳态也相关
    ...
    * 复杂性管理 - *比如极简设计、系统工程抽象接口、封装、产品的易用性；注意，复杂不等同于高级，高级（系统）除了先进、强大之外也可以保有条理性，而复杂通常只是高级的必要不充分条件*
      ...
      * 复杂性管理方法
        * 抽象封装
          * 模块化（分而治之、解耦、可重用）
          * 结构化，即分层、[分类](https://zh.wikipedia.org/wiki/%E5%88%86%E7%B1%BB%E5%AD%A6)整理
        * 建立标准与流程、规范，并档案记录化
          * 设计模式
      ...
      * [复杂系统理论](https://zh.wikipedia.org/zh-hans/%E5%A4%8D%E6%9D%82%E7%B3%BB%E7%BB%9F)
        * 连续性失效（组件强耦合）
        * 通常是开放系统
        * 可能有系统记忆（迟滞现象）
        * 可能套叠 - 系统的组成成分本身可能就是复杂系统
        * 多样性的动态网路 - 小世界或无尺度网络其中有许多局部的互动、和少量的区域间连接经常采用
        * 可能[涌现](https://zh.wikipedia.org/wiki/%E6%B6%8C%E7%8E%B0) - 为许多小实体相互作用后产生了大实体，而这个大实体展现了组成它的小实体所不具有的特性
        * 非线性关系 - 比如蝴蝶效应
        * 回馈循环（正负反馈）
  * 关系模型结构
    * 排他配对（即一对一）
  ...
  * 广义政治
    ...
    * 规则法律
      * **自然法则** - *有时与野蛮同义，特种语境下又称为街头智慧*
        ...
        * 自然数学
          * 幂次法则、[八二法则](https://zh.wikipedia.org/zh-hans/%E5%B8%95%E7%B4%AF%E6%89%98%E6%B3%95%E5%88%99)、正态分布 - 该数学法则实用于许多宏观以及微观世界场景
  ...
  * 狭义政治 - 比如权术
    * 关于权力
      * [权力基础](https://zh.wikipedia.org/zh-hans/%E6%AC%8A%E5%8A%9B) - *下面按重要性排序*
        ...
        * 参照 | Referent - 人格魅力、亲和感染力、权威威望。参考[多看效应](https://zh.wikipedia.org/zh-hans/%E5%A4%9A%E7%9C%8B%E6%95%88%E6%87%89)。*尤其是对民选领导者选举时非常重要，相比较之下一些历史上的独裁者缺乏个人魅力，但可以借助法定权获得的资源进行包装*
