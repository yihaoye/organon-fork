...
* 逻辑基础
  ...
  * [谬误](https://zh.wikipedia.org/zh-hans/%E8%AC%AC%E8%AA%A4%E5%88%97%E8%A1%A8) - *以下仅列举常见的重要谬误*
    ...
    * **词语歧义** - *语言文字用词不准确时可能会带入冗余信息或丢失信息或植入暗示、认知诱导，比如将现代医学称为西医时容易与中医形成对立对等关系，事实上通常语境下准确对应的西医（传统欧美医学）应该是古希腊-罗马医学，而现代医学应该与传统医学对立，其中传统医学除了包括中医、传统欧美医学外还包括其他地区的医学如古印度、古埃及、南美、伊斯兰医学等等。此处词语歧义呼应上面的信息熵理论*
...
* [解决问题](https://en.wikipedia.org/wiki/Problem_solving)、事务执行
  ...
  * [解决策略](https://untools.co/)与[任务管理](https://zh.wikipedia.org/zh-hans/%E6%97%B6%E9%97%B4%E7%AE%A1%E7%90%86)
    * **艾森豪威尔四象法**（紧急重要、紧急不重要、重要不紧急、不重要不紧急）
...
* [系统理论](https://writings.sh/post/cybernetics-and-scientific-methodology-notes) - *可广泛应用在工作生活，比如人体健康、家庭财务等等*
  ...
  * 反馈
    * 正反馈（单向强化）- *强者更强，比如马太效应、核反应、债务陷阱、温室效应、恶性循环等，注意正反馈性质上可以是正面也可以是负面的*
    * 负反馈（反向阻碍）- *比如制冷温度调节、市场供需波动平衡、边际效益递减等*
  * 变化
    * 量变 vs 突变（又称质变或范式转移）
