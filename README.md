...
* 逻辑基础
  ...
  * 统计
    ...
    * [因果性](https://zh.wikipedia.org/zh-hans/%E5%9B%A0%E6%9E%9C%E5%85%B3%E7%B3%BB)（系统化理论）*（对应上面例子其实水杨酸才是解热镇痛的主因）*
      ...
      * 事件时间顺序性
  * 学科审慎 - 如何鉴别伪科学
    * 充分应用（直接或间接）了数学的学科才可被称为科学的学科 - *即使是社科文科也符合，比如语言学破解灭绝语言采用密码学数学，狭义政治里的三姬分金博弈论，刑侦里的指纹识别基因匹配数据库，历史考古学采用碳 14 鉴定对比文物年代等等*
...
* 信任机制
  * 应用沉没成本和机会成本构建可靠的信任关系 - 即不主张无条件的信任
    ...
    * 如果下一次可能多出来的利益大于之前的沉没成本（该差值即机会成本），则有可能出现破坏信任关系的行为，否则则可能维持信任合作关系 *（比如小圈子里通过提供自身把柄以搭建临时团队的投名状机制）*
* 人际管理
...
* [系统理论](https://writings.sh/post/cybernetics-and-scientific-methodology-notes) - *可广泛应用在工作生活，比如人体健康、家庭财务等等*
  ...
  * 反馈
    * 正反馈（单向强化）- *比如马太效应、强者更强、核反应、债务陷阱、温室效应、恶性循环等，注意性质上可以是正面也可以是负面的*
    * 负反馈（反向阻碍）- *比如人工制冷温度调节、市场供需波动平衡、边际效益递减等*
  * 变化
    * 量变 vs 突变（又称质变或范式转移）
